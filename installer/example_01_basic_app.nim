...
var window = newWindow("NiGui Example한자")
...
var button = newButton("Button 1한자")
...
# Set an event handler for the "onClick" event (here as anonymous proc).
  ...
  textArea.addLine("Button 1 clicked, message box opened.한자")
  window.alert("This is a simple message box.한자")
  textArea.addLine("Message box closed.한자")
